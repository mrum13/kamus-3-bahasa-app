...
public class QuisInggrisActivity extends AppCompatActivity {
    TextView kuis;
    RadioGroup rg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quis_inggris);
    ...
    public void next(View view) {
        if (PilihanA.isChecked() || PilihanB.isChecked() || PilihanC.isChecked() || PilihanD.isChecked()) {
            ...
            if (nomor < pertanyaan_kuis.length) {
                ...
                hasil = benar * 20;
                Intent selesai = new Intent(getApplicationContext(), resul1Activity.class);
